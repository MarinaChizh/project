...
<body>
<div class="two"><h1>TransLogist</h1>
<h2>ГРУЗОПЕРЕВОЗКА <br> в любую точку <br> +375 xx xxx xx xx</h2></div>
  <nav class="top-menu">
    <div>
      <ul class="menu-main">
        <li class="left-item">
 ...
 ?>       
  ...
  <div>
    <?= Auth::currentUserInfo() . " " . (isset($_SESSION['user']) ? "<button type='button' class='btn btn-secondary btn-sm'><a href='?a=logout'>Выход</a></button>" : "") ?>
  </div>
  <br />
